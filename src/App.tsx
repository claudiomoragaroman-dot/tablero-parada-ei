...
const COLLECTION_NAME = "tasks_prod_v20";
...
const INITIAL_TASKS_DATA = [
  ...
  { area: "Flotacion", id: "272", ot: "798900", parent: "FLOTACIÓN - CAMBIO VÁLVULA 34", name: "Instalación instrumentación", start: d(18,18,30), end: d(18,20,30), resp: "Nicolas Gonzalez" },
  { area: "Flotacion", id: "273", ot: "-", parent: "FLOTACIÓN - CAMBIO VÁLVULA 34", name: "Retiro de andamios", start: d(18,20,30), end: d(18,21,30), resp: "Nicolas Gonzalez" },
  { area: "Flotacion", id: "274", ot: "798900", parent: "FLOTACIÓN - CAMBIO VÁLVULA 34", name: "Desbloqueo de línea", start: d(18,21,30), end: d(19,0,0), resp: "Nicolas Gonzalez" },
  { area: "Flotacion", id: "275", ot: "798900", parent: "FLOTACIÓN - CAMBIO VÁLVULA 34", name: "Calibración de válvula", start: d(18,23,30), end: d(19,0,0), resp: "Nicolas Gonzalez" },
  { area: "Flotacion", id: "277", ot: "798901", parent: "CAMBIO REDUCTOR CELDA FTR 60", name: "Bloqueo de equipo", start: d(17,9,0), end: d(17,9,30), resp: "Sebastian Elgueta" },
  { area: "Flotacion", id: "279", ot: "798901", parent: "CAMBIO REDUCTOR CELDA FTR 60", name: "Retiro instrumentación / desconexión", start: d(17,10,30), end: d(17,12,30), resp: "Sebastian Elgueta" },
  { area: "Flotacion", id: "289", ot: "-", parent: "CAMBIO REDUCTOR CELDA FTR 60", name: "Retiro de andamios", start: d(18,5,30), end: d(18,6,30), resp: "Nicolas Gonzalez" },
  { area: "Flotacion", id: "290", ot: "-", parent: "CAMBIO REDUCTOR CELDA FTR 60", name: "Desbloqueo", start: d(18,6,30), end: d(18,7,0), resp: "Sebastian Elgueta" },
  { area: "Flotacion", id: "291", ot: "-", parent: "CAMBIO REDUCTOR CELDA FTR 60", name: "Prueba de sentido de giro", start: d(18,7,0), end: d(18,7,30), resp: "Sebastian Elgueta" },
  { area: "Flotacion", id: "293", ot: "-", parent: "CAMBIO DUCTO SUCCIÓN BOMBA 141", name: "Bloqueo (Bomba 141)", start: d(17,8,0), end: d(17,9,0), resp: "Sebastian Elgueta" },
  ...
  { area: "Flotacion", id: "298", ot: "-", parent: "CAMBIO DUCTO SUCCIÓN BOMBA 142", name: "Bloqueo (Bomba 142)", start: d(17,13,30), end: d(17,14,30), resp: "Sebastian Elgueta" },
